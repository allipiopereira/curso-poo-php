                    ...
                    <div class="row">
                        ...
                        <div class="btn-group bg-white p-2  w-100 mx-auto dock">
                            <div class="mx-auto text-center">
                                <!-- aula anterior -->
                                <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>/curso-poo-php/aulas/Aula01/index.php" class="btn-group mb-1 my-3">
                                    <button type="button" class="btn icon-btn-title mx-auto mr-4 ml-4 shadow-sm" role="button" style="border-bottom-left-radius: 50px; border-top-left-radius: 50px;">
                                        ...
                                        <span class="sr-only">aula01</span>
                                ...
                                <!-- aula atual -->
                                <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>/curso-poo-php/aulas/Aula02/index.php"  class="btn-group mb-1 my-3 mr-3 ml-3">
                                    <button type="button" class="btn icon-btn-title mx-auto mr-4 ml-4 shadow-sm" role="button" style="border-bottom-left-radius: 50px; border-top-left-radius: 50px;">
                                ...
                                <!-- aula posterior -->
                                <a href="<?php $_SERVER['DOCUMENT_ROOT'];?>/curso-poo-php/aulas/Aula03/index.php"  class="btn-group mb-1 my-3">
